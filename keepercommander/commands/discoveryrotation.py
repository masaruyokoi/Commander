...
from .discover.start import PAMGatewayActionDiscoverStartCommand
from .discover.status import PAMGatewayActionDiscoverStatusCommand
from .discover.process import PAMGatewayActionDiscoverProcessCommand
from .discover.get import PAMGatewayActionDiscoverGetCommand
...
class PAMDiscoveryCommand(GroupCommand):
    ...
    def __init__(self):
        ...
        self.register_command('start', PAMGatewayActionDiscoverStartCommand(), 'Start a discovery process', 's')
        self.register_command('status', PAMGatewayActionDiscoverStatusCommand(), 'Status of discovery processes', 's')
        self.register_command('process', PAMGatewayActionDiscoverProcessCommand(), 'Process discovered items', 'p')
        # self.default_verb = 'list'
